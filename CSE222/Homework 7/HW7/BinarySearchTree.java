...
public class BinarySearchTree<E extends Comparable<E>> extends BinaryTree<E> implements SearchTree<E> {
    ...
    public boolean add(E item, boolean isRed) {
        root = add(root, item, isRed);
        if(addReturn){
        //    System.out.println("item " + item +" and "  + isRed);
        //    root.isRed = isRed;
        //    System.out.println("rooisted: " + root.isRed);
    ...
    private Node<E> add(Node<E> localRoot, E item, boolean isRed) {
        if (localRoot == null) {
